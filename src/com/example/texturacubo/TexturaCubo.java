package com.example.texturacubo;
...
public class TexturaCubo extends RendererActivity {
	...
	public void initScene() 
	{
		...
		b = Utils.makeBitmapFromResourceId(R.drawable.ubuntu);
		Shared.textureManager().addTextureId(b, "ubuntu", false);
		b.recycle();
		
		// Add textures to sphere
		_cube.textures().addById("ubuntu");
	}
